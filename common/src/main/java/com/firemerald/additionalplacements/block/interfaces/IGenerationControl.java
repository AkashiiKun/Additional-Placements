...
/**
 * A mod author may choose to add the method below (<b>with or without implementing this interface</b>) on a custom block class to further control whether an additional placement block can be generated for it.</br>
...
public interface IGenerationControl {
	 ...
	 */
    boolean additionalplacements$generateAdditionalStates();
}
